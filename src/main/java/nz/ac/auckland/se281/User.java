    ...
    for (Policy policy : policies) {
      if (policy instanceof Life) {
        MessageCli.PRINT_DB_LIFE_POLICY.printMessage(
            ...
            Integer.toString(policy.getPremium() * (100 - discount) / 100));
      }
      ...
      if (policy instanceof Car) {
        ...
        MessageCli.PRINT_DB_CAR_POLICY.printMessage(
            car.getMakeAndModel(),
            car.getSumInsured(),
            Integer.toString(car.getPremium()),
            Integer.toString(car.getPremium() * (100 - discount) / 100));
      }
      ...
      if (policy instanceof Home) {
        ...
        MessageCli.PRINT_DB_HOME_POLICY.printMessage(
            home.getAddress(),
            home.getSumInsured(),
            Integer.toString(home.getPremium()),
            Integer.toString(home.getPremium() * (100 - discount) / 100));
      }
    }
  }
